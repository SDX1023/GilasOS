        ...
        {(["work", "shortBreak", "longBreak"] as const).map((m) => (
          <button
            ...
            style={{
              ...
              background: mode === m ? "var(--os-accent)" : "var(--os-glass-hover)",
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        <button
          ...
          style={{
            ...
            background: isRunning ? "var(--os-glass-hover)" : "var(--os-accent)",
        ...
        <button
          onClick={reset}
          style={{
            padding: 12, borderRadius: 14, background: "var(--os-glass-hover)",
